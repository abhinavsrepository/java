...
public class RestaurantController {
	 ...
	 */
	@GetMapping("/details")
	public String getrestaurantsbyid(Model map,@RequestParam Long restaurant_id) {
		
		
		map.addAttribute("restaurant",restaurantService.getRestaurantDetails(restaurant_id));
