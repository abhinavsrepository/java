...
These are the examples of ready made aspects - spring supplied.

Objectve - create a custom aspect for logging incoming requests
to the backend of the full stack app.
...
OR
@Before("execution (BlogPostDTO com.blogs.service.*.*(..))")
