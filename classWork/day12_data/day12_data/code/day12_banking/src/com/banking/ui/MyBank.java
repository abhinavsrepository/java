			...
			while (!exit) {
				try {
					System.out.println("Options - 1 : Create A/C \n " + "2. Display All accounts \n "
							...
							+ "6.Transfer Funds  \n " + "7.Close account   "+ "8.Sorted account     \n "+ "0. Exit");
					switch (sc.nextInt()) {
					case 1:
					...
					case 7:
						...
						break;
					case 8 :
						System.out.println("the sorted order of the account no");
						ops.sortAccountById();
                        break;
					case 9 :
					System.out.println("Sort bank account as per a/c opening date(dob) and balance -custom order");
					break;
					case 0:
						exit = true;
						break;
