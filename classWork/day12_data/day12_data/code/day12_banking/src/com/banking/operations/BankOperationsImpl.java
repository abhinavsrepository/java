...
public class BankOperationsImpl implements BankOperations {
	...
	public void sortAccountById() {
		//public static void sort (List<T>List)-Natural order
...
//			//anno 
//			@Override 
//			opublic int compare(BankAccount a1,BankAccount a2) {
//				System.out.println("in compare anno inner class");
//				
//				//1sr
//				int ret = a1.getAcctNo();
//				
//				
//			}
//		})
//	}
	...
	@Override
	public String naturalOrdering(int acctNo) throws BankingException {
