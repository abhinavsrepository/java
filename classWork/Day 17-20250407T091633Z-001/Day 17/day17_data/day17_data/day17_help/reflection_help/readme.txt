...
Entry Point for all reflection -- java.lang.Class<T> -- represents loaded class information in method area.
...
1. To find fully qualified class name / interface name
...
4. To find interfaces implemented by any class 
public Class<?>[] getInterfaces()
Determines the interfaces implemented by the class 


4.5 To find direct super interfaces of any sub interface -
...
6. To get all fields(not inherited) , including private fields
