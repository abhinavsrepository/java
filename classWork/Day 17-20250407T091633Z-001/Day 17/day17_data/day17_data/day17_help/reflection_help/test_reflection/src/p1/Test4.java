...
public class Test4 {
	...
	public static void main(String[] args) throws Exception {
		...
		Constructor<Emp> defCtor=empClass.getConstructor();
		Emp e =defCtor.newInstance();
		...
		Constructor<Emp> constructor = 
				empClass.getConstructor(String.class,double.class);
		...
		Method updateMethod = 
				empClass.getDeclaredMethod
				("updateSalary",double.class);
		//enable permission
