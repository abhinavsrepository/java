...
public class Tester {
	...
	public static void main(String[] args) throws InterruptedException{
		...
		RunnableTask task=new RunnableTask();//only thread
		...
		Thread t3=new Thread(task, "three");//runnable - 1 shared task among each other
		
		
		t1.start();
		//t1.start();re invoking the main the dead thread
		t2.start();
		t3.start();
