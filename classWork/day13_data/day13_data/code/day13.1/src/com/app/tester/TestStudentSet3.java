...
public class TestStudentSet3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Added " + students.add(s2));//t hc-1 eq-0
		System.out.println("Added " + students.add(s3));
		System.out.println("Added " + students.add(s4));
		System.out.println("Added " + students.add(s5));
		System.out.println("Added " + students.add(s6));//t hc-1 equal -2
		System.out.println("Added " + students.add(s7));//t hc-1 equal -3
